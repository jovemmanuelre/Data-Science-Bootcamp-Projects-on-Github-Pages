...
My goal in this project was to conduct an exploratory analysis to identify the target customers of my product.
...
I was able to cluster the customers into 4 based on their Loyalty and Satisfaction, as shown the Graph below. With this Graph, I can now design the appropriate methods to target these customers according to their clusters.
